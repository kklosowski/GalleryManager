...
import com.example.eterd.galleryv2.Adapters.GalleryCursorAdapter;
    ...
    public void populateGridView() {
        ...
        if (mCursor.moveToFirst()) {
            while (!mCursor.isAfterLast()) {
                pathArrayList.add(i++,mCursor.getString(1));
                mCursor.moveToNext();
            }
        }
        mCursor.moveToFirst();
        ...
        GalleryCursorAdapter galleryCursorAdapter = new GalleryCursorAdapter(this, mCursor, 0, pathArrayList);
